...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Lucky.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          ...
          web.
          <img
            className="sqD w-40 top-[-20px] left-[85%] sm:left-[87%] lg:left-[89%]"
            style={{ animationDelay: "0.15s" }}
            src="/static/doodles/hero/clover.svg"
            alt=""
          />
          <img
          ...
          <img
            ...
            src="/static/doodles/hero/lucky.svg"
            alt=""
          />
          <img
